...
<form className="zip-input">
  <div className="flex items-center py-2">  
    <input className="appearance-none text-center bg-green border-none rounded-lg w-full text-white mr-3 py-1 px-2 leading-tight focus:outline-green focus:placeholder-opacity-0 placeholder-white" placeholder="ZIP Code" text-w aria-label="zipcode"></input>
  </div>
